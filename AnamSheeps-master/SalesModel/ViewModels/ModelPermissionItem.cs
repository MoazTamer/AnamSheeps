...
namespace SalesModel.ViewModels
{
   ...
   //         //-----------------------------------------------------------------------------------
			...
			//-----------------------------------------------------------------------------------
			new Claim("عرض العملاء", "العملاء"),
			new Claim("Customer_View", "True"),
			new Claim("Customer_Create", "True"),
			new Claim("Customer_Edit", "True"),
			new Claim("Customer_Delete", "True"),
            //-----------------------------------------------------------------------------------
			new Claim("عرض الموردين", "الموردين"),
			new Claim("Supplier_View", "True"),
			new Claim("Supplier_Create", "True"),
			new Claim("Supplier_Edit", "True"),
			new Claim("Supplier_Delete", "True"),
            //-----------------------------------------------------------------------------------
            new Claim("عرض المنتجات", "المنتجات"),
            new Claim("Product_View", "True"),
			new Claim("Product_Create", "True"),
			new Claim("Product_Edit", "True"),
			new Claim("Product_Delete", "True"),
            //-----------------------------------------------------------------------------------
			new Claim("عرض بنود المصروفات", "بنود المصروفات"),
			new Claim("ExpenseItem_View", "True"),
			new Claim("ExpenseItem_Create", "True"),
			new Claim("ExpenseItem_Edit", "True"),
			new Claim("ExpenseItem_Delete", "True"),

			//-----------------------------------------------------------------------------------
			new Claim("أمين مستودع","أمين مستودع"),
            new Claim("Amin","Amin"),
            new Claim("Amin","0"),
            new Claim("Amin","0"),
            new Claim("Amin","0"),
			//-----------------------------------------------------------------------------------
			new Claim("مندوب","مندوب"),
            new Claim("Mandub","Mandub"),
            new Claim("Mandub","0"),
            new Claim("Mandub","0"),
            new Claim("Mandub","0"),
            //-----------------------------------------------------------------------------------
		
			new Claim("تقرير المبيعات","تقرير المبيعات"),
            new Claim("SalesReport","SalesReport"),
            new Claim("SalesReport","0"),
            new Claim("SalesReport","0"),
            new Claim("SalesReport","0"),
			//-----------------------------------------------------------------------------------
			new Claim("تقرير المشتريات","تقرير المشتريات"),
            new Claim("PurchasesReport","PurchasesReport"),
            new Claim("PurchasesReport","0"),
            new Claim("PurchasesReport","0"),
            new Claim("PurchasesReport","0"),
            //-----------------------------------------------------------------------------------
