        ...
        public IActionResult Create()
        {
            try
            {
                ...
                var model = new ModelUsers
                {
                    ...
                    {
                        new SelectListItem { Text = "مندوب", Value = "مندوب" },
                        new SelectListItem { Text = "أمين مستودع", Value = "أمين مستودع" },
                        new SelectListItem { Text = "إدارة", Value = "إدارة" }
                    }
                };
        ...
        public async Task<IActionResult> Create(ModelUsers modelUsers)
        {
            try
            {
                ...
                if (!roleExists)
                {
                    ...
                    {
                        Name = user.UserType,
                        NormalizedName = user.UserType.ToUpper()
                    };
                ...
                if (!roleResult.Succeeded)
                {
                    ...
                    return Json(new { isValid = false, title = Title, message = $"تم إنشاء المستخدم لكن فشل إضافة الصلاحية: {errors}" });
                }
            ...
            {
                return Json(new { isValid = false, title = Title, message = $"حدث خطأ: {ex.Message}" });
            }
        }
